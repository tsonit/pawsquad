            ...
            $('.datatables-products').DataTable({
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        targets: 3,
                        render: function(data, type, full, meta) {
                            return full['attribute_set_name'];
                        }
                    },
                    {
                        // Status
                ...
                buttons: [{
                    text: '<i class="ti ti-plus ti-xs me-md-2"></i><span class="d-md-inline-block d-none">Tạo thuộc tính</span>',
                    className: 'btn btn-primary waves-effect waves-light',
                    action: function(e, dt, button, config) {
                        window.location = "{{ route('admin.attributes.addAttribute') }}";
                    }
                }],
