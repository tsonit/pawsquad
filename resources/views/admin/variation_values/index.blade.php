    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Danh sách giá trị biến thể</h5>
                <small class="text-muted">Đây là giá trị biến thể</small>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.datatables-products').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.variations-values.index') }}",
                    type: 'POST',
                    headers: {
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        targets: 2,
                        render: function(data, type, full, meta) {
                            return limitText(full['variation_name'], 20);
                        }
                    },
                    {
                        // Name
                ...
                buttons: [{
                    text: '<i class="ti ti-plus ti-xs me-md-2"></i><span class="d-md-inline-block d-none">Tạo giá trị</span>',
                    className: 'btn btn-primary waves-effect waves-light',
                    action: function(e, dt, button, config) {
                        window.location =
                            "{{ route('admin.variations-values.addVariationValues') }}";
                    }
                }],
                ...
                responsive: {
                    details: {
                        display: $.fn.dataTable.Responsive.display.modal({
                            header: function(row) {
                                var data = row.data();
                                return 'Chi tiết giá trị - ' + data['name'];
                            }
                        }),
                        type: 'column',
