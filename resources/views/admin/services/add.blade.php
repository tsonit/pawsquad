                            ...
                            <div class="card-body">
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tên dịch vụ" name="name"
                                        aria-label="Tên dịch vụ" value="{{ old('name') }}" id="title"
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea rows="5" class="form-control" placeholder="Mô tả ngắn"
                                        name="short_description" aria-label="Mô tả ngắn">{{ old('short_description') }}</textarea>
                                </div>
