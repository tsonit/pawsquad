    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Danh sách dịch vụ bị xoá</h5>
                <small class="text-muted">Đây là dịch vụ bị xoá</small>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.datatables-products').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.services.trashed') }}",
                    type: 'POST',
                    headers: {
                ...
                buttons: [{
                    text: '<i class="ti ti-plus ti-xs me-md-2"></i><span class="d-md-inline-block d-none">Tạo dịch vụ</span>',
                    className: 'btn btn-primary waves-effect waves-light',
                    action: function(e, dt, button, config) {
                        window.location = "{{ route('admin.services.addService') }}";
                    }
                }],
                ...
                responsive: {
                    details: {
                        display: $.fn.dataTable.Responsive.display.modal({
                            header: function(row) {
                                var data = row.data();
                                return 'Chi tiết dịch vụ - ' + data['name'];
                            }
                        }),
                        type: 'column',
