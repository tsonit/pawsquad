                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-6">
                                    ...
                                    <select id="category" class="select2 form-select" data-placeholder="Chọn danh mục"
                                        ...
                                        @forelse($categories as $row)
                                            <option value="{{ $row->id }}"
                                                {{ old('category', $data->category) == $row->id ? 'selected' : '' }}>
                                                {{ $row->name }}
                                            </option>
                                        @empty
                                ...
                                <div class="form-group mt-3 mb-3">
                                    <label for="validationCustom05" class="col-form-label pt-0">Mô
                                        tả ngắn</label>
                                    <textarea class="form-control w-100" rows="4" cols="12" max="100" name="description">{{ old('description',$data->description) }}</textarea>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nội dung nút" name="button_text"
                                        aria-label="Nội dung nút" value="{{ old('button_text',$data->button_text) }}" />
                                </div>
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Đường dẫn nút"
                                        ...
                                        value="{{ old('button_link_text',$data->button_link_text) }}" />
                                </div>
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Thứ tự" name="order"
                                        aria-label="Thứ tự" value="{{ old('order',$data->order) }}" />
                                </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status === 'success') {
                                    var avatarImage = "{{ session('slider.image') }}";
