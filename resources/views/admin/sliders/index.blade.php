    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Danh sách các slider</h5>
                <small class="text-muted">Đây là các slider</small>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.datatables-products').DataTable({
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            var $row_output =
                                '<div class="d-flex flex-column justify-content-start align-items-start product-name">';
                            ...
                            if ($title) {
                                ...
                                $row_output += '<h6 class="text-nowrap mb-0">' + limitText($title,
                                    20) + '</h6>';
                                $row_output += '</div>';
                            }
                ...
                buttons: [{
                        text: '<i class="ti ti-plus ti-xs me-md-2"></i><span class="d-md-inline-block d-none">Tạo slider</span>',
                        className: 'btn btn-primary waves-effect waves-light',
                        action: function(e, dt, button, config) {
                            window.location = "{{ route('admin.sliders.addSliders') }}";
                        }
                    }
                ],
                ...
                responsive: {
                    details: {
                        display: $.fn.dataTable.Responsive.display.modal({
                            header: function(row) {
                                var data = row.data();
                                return 'Chi tiết slider - ' + data['id'];
                            }
                        }),
                        type: 'column',
