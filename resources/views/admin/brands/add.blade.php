        ...
        <div class="app-ecommerce">
            <div
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-1">Thêm nhãn hàng</h4>
                            ...
                            <div class="card-body">
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="Tên nhãn hàng" name="name" id="title" aria-label="Tên nhãn hàng"
                                        value="{{ old('name') }}" onkeyup="ChangeToSlug();" />
                                </div>
                                <div class="mb-6">
                                    <label class="form-label" for="ecommerce-product-name">Đường dẫn</label>
                                    <input type="text" class="form-control"
                                        placeholder="Đường dẫn nhãn hàng" name="slug" id="slug" aria-label="Đường dẫn nhãn hàng"
                                        value="{{ old('slug') }}" />
                                </div>
                                <div class="form-group mt-3">
                                    <label for="validationCustom05" class="col-form-label pt-0">Mô
                                        tả</label>
                                    <textarea class="tsonit w-100" rows="4" cols="12" name="description">{{ old('description') }}</textarea>
                                </div>
