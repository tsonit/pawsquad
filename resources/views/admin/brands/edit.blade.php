        ...
        <div class="app-ecommerce">
            <div
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-1">Sửa nhãn hàng</h4>
                        ...
                        <div class="card mb-6 ">
                            ...
                            <div class="card-body">
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tên nhãn hàng" name="name"
                                        id="title" aria-label="Tên nhãn hàng" value="{{ old('name', $data->name) }}"
                                        onkeyup="ChangeToSlug();" />
                                </div>
                                <div class="mb-6">
                                    <label class="form-label" for="ecommerce-product-name">Đường dẫn</label>
                                    <input type="text" class="form-control" placeholder="Đường dẫn nhãn hàng"
                                        name="slug" id="slug" aria-label="Đường dẫn nhãn hàng"
                                        value="{{ old('slug', $data->slug) }}" />
                                </div>
                                <div class="form-group mt-3">
                                    <label for="validationCustom05" class="col-form-label pt-0">Mô
                                        tả</label>
                                    <textarea class="tsonit w-100" rows="4" cols="12" name="description">{!! old('description', $data->description) !!}</textarea>
                                </div>
                                ...
                                <div class="mb-6  border-top mt-2">
                                    ...
                                    <div class="dropzone needsclick p-0" id="dropzone-brand" data-type="avatar">
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\BrandsRequestAdmin') !!}
    <script>
        $(document).ready(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status === 'success') {
                                    var avatarImage = "{{ session('brand.image') }}";
            ...
            var myDropzone = initializeDropzone("#dropzone-brand");
            ...
            const tourSteps = [{
                    title: 'Tên nhãn hàng',
                    text: 'Đây có thể là thể loại sản phẩm hoặc tên thể loại con. Ví dụ: Nhãn hàng a',
                    element: '[name="name"]'
                },
                {
                    title: 'Đường dẫn',
                    text: 'Đây là đường dẫn của nhãn hàng. ',
                    element: '[name="slug"]'
                },
                {
                    title: 'Hiển thị',
                ...
                {
                    title: 'Hình ảnh',
                    text: 'Ảnh đại diện (thumbnail) của nhãn hàng',
                    element: '[name="img"]'
                },
                {
                    title: 'Meta Title',
