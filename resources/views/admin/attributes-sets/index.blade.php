    ...
    <script>
        $(document).ready(function() {
            $('.datatables-products').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.attributes_sets.index') }}",
                    type: 'POST',
                    headers: {
                ...
                buttons: [{
                    text: '<i class="ti ti-plus ti-xs me-md-2"></i><span class="d-md-inline-block d-none">Tạo nhóm thuộc tính</span>',
                    className: 'btn btn-primary waves-effect waves-light',
                    action: function(e, dt, button, config) {
                        window.location =
                            "{{ route('admin.attributes_sets.addAttribute_Set') }}";
                    }
                }],
                ...
                responsive: {
                    details: {
                        display: $.fn.dataTable.Responsive.display.modal({
                            header: function(row) {
                                var data = row.data();
                                return 'Chi tiết nhóm - ' + data['name'];
                            }
                        }),
                        type: 'column',
