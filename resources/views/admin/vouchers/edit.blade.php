        ...
        <div class="app-ecommerce">
            <div
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-1">Sửa mã giảm giá</h4>
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control status" name="index" id="status">
                                                        <option value="1"
                                                            {{ old('index', $voucher->index) == 1 ? 'selected' : '' }}>Hiện</option>
                                                        <option value="0"
                                                            {{ old('index', $voucher->index) == 0 ? 'selected' : '' }}>Ẩn</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control" name="discount_type" id="discount_type">
                                                        <option value="flat"
                                                            {{ old('discount_type',$voucherType->discount_type) == 'flat' ? 'selected' : '' }}>Giảm
                                                            theo tiền
                                                        </option>
                                                        <option value="percentage"
                                                            {{ old('discount_type',$voucherType->discount_type) == 'percentage' ? 'selected' : '' }}>
                                                            Giảm theo phần
                                                            trăm</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('discount',$voucherType->discount) }}">
                                        ...
                                        <div class="tab-pane fade" id="navs-limit" role="tabpanel">
                                            <div class="mb-6">
                                                ...
                                                <input type="number" class="form-control"
                                                    ...
                                                    value="{{ old('min_spend', $voucherType->min_spend) }}" />
                                            </div>
                                            <div class="mb-6">
                                                ...
                                                <input type="number" class="form-control"
                                                    ...
                                                    value="{{ old('customer_usage_limit', $voucherType->customer_usage_limit) }}" />
                                            </div>
                                            <div class="mb-6">
                                                <label class="form-label">Số lượng</label>
                                                <input type="number" class="form-control" placeholder="Số lượng"
                                                    name="quantity" aria-label="Số lượng"
                                                    value="{{ old('quantity', $voucher->voucher_quantity) }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
