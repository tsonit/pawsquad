            ...
            <div class="row d-flex justify-content-center g-4">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="form-wrapper wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s">
                        ...
                        @if ($status)
                            <form class="w-100" method="POST" action="{{ route('postResetPassword') }}">
                                <div class="row">
                                    <div class="col-12 mb-3 relative">
                                        ...
                                        <div class="input-wrapper-password">
                                            <input name="password" placeholder="Mật khẩu" id="password"
                                            ...
                                            <button type="button" id="toggle-password" class="flex items-center">
                                                ...
                                                <svg id="eye-slash-icon"
                                                    class="h-5 w-5 text-jacarta-700 dark:text-white hidden" fill="none"
                                ...
                                @csrf
                                <button class="account-btn">Thay đổi</button>
                            </form>
                        @else
...
@endsection
@section('js')
    {!! JsValidator::formRequest('App\Http\Requests\Auth\ResetPasswordFormRequest') !!}
    <script>
