            ...
            <div class="row d-flex justify-content-center g-4">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="form-wrapper wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s">
                        ...
                        <form class="w-100" method="POST" action="{{ route('postLogin') }}">
                            <div class="row">
                                <div class="col-12">
                        ...
                        <div class="alternate-signup-box">
                            ...
                            <div class="btn-group gap-4">
                                <a href="{{ route('login.google',['provider' => 'google']) }}" class="eg-btn google-btn d-flex align-items-center"><i
                                        class="bx bxl-google"></i><span>Đăng nhập bằng Google</span></a>
                            </div>
                        </div>
                    </div>
                </div>
...
@endsection
@section('js')
    {!! JsValidator::formRequest('App\Http\Requests\Auth\LoginFormRequest') !!}
    <script>
