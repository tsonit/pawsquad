<div class="row align-items-center g-4 mt-3">
    <form action="{{ route('address.update') }}" method="POST"  id="address_info">
        @csrf
        ...
        <div class="row g-4 form-wrapper">
            ...
            <div class="col-sm-6">
                <div class="w-100 label-input-field form-inner">
                    ...
                    <select class="select2Address" name="province_id" autocomplete="off" role="presentation">
            ...
            <div class="col-sm-6">
                <div class="w-100 label-input-field form-inner">
                    ...
                    <select class="select2Address" name="district_id" autocomplete="off" role="presentation">
            ...
            <div class="col-sm-6">
                <div class="w-100 label-input-field form-inner">
                    ...
                    <select class="select2Address" name="ward_id" autocomplete="off" role="presentation">
            ...
            <div class="col-sm-6">
                <div class="w-100 label-input-field form-inner">
                    ...
                    <select class="select2Address" name="village_id" autocomplete="off" role="presentation">
            ...
            <div class="col-sm-12">
                <div class="w-100 label-input-field form-inner">
                    ...
                    <input  placeholder="Số nhà ABC, ngõ 5/2" name="address" autocomplete="off"
